define([
	...
	var _DialogBase = declare("dijit._DialogBase" + (has("dojo-bidi") ? "_NoBidi" : ""), [_TemplatedMixin, _FormMixin, _DialogMixin, _CssStateMixin], {
		...
		show: function(){
			...
			this._modalBoxconnects.push(on(win, "scroll", lang.hitch(this, "resize", null)));

			this._modalBoxconnects.push(on(this.domNode, "keydown", lang.hitch(this, "_onKey")));
		...
		hide: function(){
			...
			var h;
			while(h = this._modalBoxconnects.pop()){
				h.remove();
			}
	...
	var Dialog = declare("dijit.Dialog", [ContentPane, _DialogBase], {
		// summary:
		//		A modalBox dialog Widget.
		// description:
		//		Pops up a modalBox dialog window, blocking access to the screen
